...
public class Viewcategory extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        viewcattitle = new javax.swing.JLabel();
        close1 = new javax.swing.JLabel();
        minimize = new javax.swing.JLabel();
        jPanel1 = new javax.swing.JPanel();
        backstock = new javax.swing.JLabel();
        jScrollPane1 = new javax.swing.JScrollPane();
        viewingcatdet = new javax.swing.JTextArea();
        clickcat = new javax.swing.JLabel();
        ...
        viewcattitle.setFont(new java.awt.Font("Tahoma", 1, 14)); // NOI18N
        viewcattitle.setForeground(new java.awt.Color(255, 255, 255));
        viewcattitle.setText("View Category");
        ...
        viewingcatdet.setEditable(false);
        viewingcatdet.setBackground(new java.awt.Color(51, 51, 55));
        viewingcatdet.setColumns(20);
        viewingcatdet.setForeground(new java.awt.Color(255, 255, 255));
        viewingcatdet.setRows(5);
        jScrollPane1.setViewportView(viewingcatdet);

        clickcat.setForeground(new java.awt.Color(255, 255, 255));
        clickcat.setText("Click here to view categories");
        clickcat.addMouseListener(new java.awt.event.MouseAdapter() {
            public void mouseClicked(java.awt.event.MouseEvent evt) {
                clickcatMouseClicked(evt);
            }
        });
        ...
        jPanel3Layout.setHorizontalGroup(
            ...
            .addGroup(jPanel3Layout.createSequentialGroup()
                .addContainerGap()
                .addComponent(viewcattitle, javax.swing.GroupLayout.PREFERRED_SIZE, 112, javax.swing.GroupLayout.PREFERRED_SIZE)
        ...
        jPanel3Layout.setVerticalGroup(
            ...
            .addGroup(jPanel3Layout.createSequentialGroup()
                ...
                .addGroup(jPanel3Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                    ...
                    .addComponent(viewcattitle, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE))
                .addGap(18, 18, 18)
    ...
    private void clickcatMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_clickcatMouseClicked
        String vcatFile = "C:\\Users\\Hafsa\\Documents\\NetBeansProjects\\category.txt";
        File filecat = new File(vcatFile);

        try{
            FileReader frc = new FileReader(filecat);
            BufferedReader br = new BufferedReader(frc);
            viewingcatdet.read(br,null);
            br.close();
            viewingcatdet.requestFocus();
        }
        catch(Exception e){
            JOptionPane.showMessageDialog(null, e);
        }
    }//GEN-LAST:event_clickcatMouseClicked
    ...
    private javax.swing.JLabel clickcat;
    private javax.swing.JLabel close1;
    private javax.swing.JPanel jPanel1;
    private javax.swing.JPanel jPanel3;
    private javax.swing.JScrollPane jScrollPane1;
    private javax.swing.JLabel minimize;
    private javax.swing.JLabel viewcattitle;
    private javax.swing.JTextArea viewingcatdet;
